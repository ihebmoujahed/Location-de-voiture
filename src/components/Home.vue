...
<html>
  ...
  <div>
    ...
    <div id="carouselExampleIndicators" class="carousel slide" data-bs-ride="carousel"
      ...
      <h3 style="text-align: center">Location de voiture en Tunisie</h3>
      <p style="text-align:center;font-weight:bold;font-size:18px;color: #800000 !important;margin-top:52px">AVANTGARDE
        RENT A CAR</p>
    </div>
